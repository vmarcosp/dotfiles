...
- **macOS**: `uname -s` is Darwin. Homebrew, Kitty, Ghostty under `~/Library/Application Support/com.mitchellh.ghostty`, nvm, `caffeinate`/`awake`, `reattach-to-user-namespace`.
