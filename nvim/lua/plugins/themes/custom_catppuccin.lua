			...
			highlight_overrides = {
				all = function(colors)
					return {
						...
						AvanteTitle = { bg = colors.blue, fg = colors.base }, -- Vermelho
						AvanteReversedTitle = { bg = colors.base, fg = colors.blue }, -- Verde
						AvanteThirdTitle = { bg = colors.blue, fg = colors.base }, -- Rosa choque
						AvanteReversedThirdTitle = { bg = colors.base, fg = colors.blue }, -- Ciano
						AvantePromptInput = { bg = colors.surface1, fg = "#fafafa" }, -- Khaki
						AvantePromptInputBorder = { bg = colors.surface1, fg = "#fafafa" }, -- Ameixa
						AvanteSidebarWinSeparator = { bg = colors.base, fg = colors.surface1 }, -- Vermelho fogo
						AvanteInlineHint = { bg = colors.base, fg = colors.base },
						AvantePopupHint = { bg = colors.base, fg = colors.base },
